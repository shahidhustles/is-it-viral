...
export function AnalysisReport({ reportId }: AnalysisReportProps) {
  ...
  const metrics = [
    { label: "Cohort verdict", value: report.verdict, detail: "rule-based simulated outcome" },
    ...
    <div className="space-y-14">
      ...
      <section aria-labelledby="simulation-metrics" className="space-y-5">
        <div className="max-w-2xl space-y-2">
          ...
          <p className="text-muted-foreground">This simulated cohort outcome is guidance, not a reproduction or prediction of Instagram’s private ranking system.</p>
        </div>
